                  ...
                  <tr key={b.id} className="hover:bg-neutral-800/40 transition-colors">
                    ...
                    <td className="px-5 py-3.5">
                      <button
                        ...
                        className="font-medium text-white hover:text-white transition-colors flex items-center space-x-1"
                      >
                        <span>{b.trip_title}</span>
                        <ArrowUpRight className="w-3 h-3 text-neutral-500" />
                      </button>
                      <span className="text-[10px] text-neutral-400 font-mono">#{b.trip_id}</span>
                    </td>

                    <td className="px-5 py-3.5 uppercase text-[11px] font-semibold text-neutral-400">{b.item_type}</td>

                    <td className="px-5 py-3.5 font-medium text-neutral-200">{b.vendor_name || b.vendor_id}</td>
